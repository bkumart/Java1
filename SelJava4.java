...
public class SelJava4 {
	...
	String yo = "https://facebook.com/";  
		practice.get(yo);
		practice.findElement(By.xpath("//*[@id='email']")).sendKeys("Bharath");
		System.out.println(practice.findElement(By.xpath("//*[@id='u_0_i']")).isSelected());
		practice.findElement(By.xpath("//*[@id='u_0_q']")).click();
		System.out.println(practice.findElement(By.xpath("//*[@id='u_0_i']")).isSelected());
		...
		obj.sendKeys(Keys.SHIFT).sendKeys("Pawan Kalyan").build().perform();
